...
class Game {
  ...
  doBotMove() {
    ...
    if (this.currPlayer.id === 1) {
      ...
      let winningMoves = this.bot.findWinningMove(this.board, 1)
      let defenseMoves = this.bot.findDefenceMove(this.board, 1)
      let futureWinMove = this.bot.findFutureWinningMove(this.board, 1)
      futureWinMove = this.bot.checkIfMoveWillResultInEnemyWinning(futureWinMove, this.board)
      futureWinMove = this.bot.checkIfMoveWillResultInPincerAttack(futureWinMove, this.board)
      let futureDefenseMove = this.bot.findFutureDefenseMove(this.board, 1)
      futureDefenseMove = this.bot.checkIfMoveWillResultInEnemyWinning(futureDefenseMove, this.board)
      futureDefenseMove = this.bot.checkIfMoveWillResultInPincerAttack(futureDefenseMove, this.board)
      let futurePincerMove = this.bot.findFuturePincerMove(this.board, 1)
      futurePincerMove = this.bot.checkIfMoveWillResultInEnemyWinning(futurePincerMove, this.board)
      let pincerDefenseMove = this.bot.findPincerDefenseMove(this.board, 1)
      pincerDefenseMove = this.bot.checkIfMoveWillResultInEnemyWinning(pincerDefenseMove, this.board)
      pincerDefenseMove = this.bot.checkIfMoveWillResultInPincerAttack(pincerDefenseMove, this.board)
      ...
      if (moves.length === 0) {
        move = Math.floor(Math.random() * (this.width - 1))
        var y = this.bot.findSpotForCol(this.board, move, this.board.length);
        if (y !== null) {

          if ((this.bot.checkIfMoveWillResultInEnemyWinning([move], this.board).length !== 0 && this.bot.checkIfMoveWillResultInPincerAttack([move], this.board).length !== 0) || this.count > 10) {
